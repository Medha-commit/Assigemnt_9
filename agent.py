...
async def main():
    ...
    history = ConversationHistory()  # Initialize history
    ...
    try:
        while True:
            ...
            # Search relevant history before processing
            relevant_history = await history.search_relevant(user_input)
            if relevant_history:
                print("\n📚 Found relevant previous conversations:")
            ...
            while True:
                ...
                if isinstance(result, dict):
                    ...
                    # When saving final answer
                    if "FINAL_ANSWER:" in answer:
                        final_response = answer.split('FINAL_ANSWER:')[1].strip()
                        print(f"\n💡 Final Answer: {final_response}")
                        
                        # Save conversation to history
                        await history.add_entry(
